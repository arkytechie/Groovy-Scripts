...
def Message processData(Message message) 
{
	...
	def diffCount = mapProperty.get("differenceCount")
	...
	if (diffCount != totalCountOfResponses) {
		//Message Log Factory
       ...
       //Throw exception
       throw new Exception("Response Count error:" + diffCount + " != " + aXmlResponse.Root.size())
